...
- No hay backend — todo es frontend con localStorage
- Los datos de contenido están en `src/data/learningData.js`
- El tema es dark (#0d0d1a) — respetar la paleta existente
- Base path es `/claude-tracker/` — no cambiarlo
